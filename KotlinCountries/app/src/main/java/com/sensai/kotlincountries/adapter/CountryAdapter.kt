...
import com.sensai.kotlincountries.databinding.ItemCountryBinding
...
class CountryAdapter(val countryList: ArrayList<Country>) :
   ...
   */
    ...
    override fun onCountryClicked(v: View) {
        ...
        val action=FeedFragmentDirections.actionFeedFragmentToCountryFragment(countryUuid = uuid)
